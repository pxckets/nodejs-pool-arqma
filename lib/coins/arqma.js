...
function Coin(data){
    ...
    this.coinDevAddress = "ar3ewpDnPGPN32YeFrcuspB16XmJmTTLpNaGnqomf6yvBGjQQ81sxp6XaQKWNCYtjsHkwEV7xSPake3mc1oubqoL17PF8uptF";  // ArqTras
    this.poolDevAddress = "ar4KLwmWjJZLyVWMfn2hmr16tLSZeuoPhSQHeunqbf3me7RcdikPCg4ZKNXA4GZiwzZCoQiNnFEDEHTE6ezaWuHd1R2QoHaHJ";  //  dev fee
    ...
    this.prefix = 0x2cca;
    this.intPrefix = 0x116bc7;

    if (global.config.general.testnet === false){
    //    this.prefix = 1062;
...
//this.cryptoNight = multiHashing.cryptonight_light;
  this.cryptoNight = function(convertedBlob) {
    //      return multiHashing.cryptonight_light(convertedBlob, convertedBlob[0] >= 7 ? convertedBlob[0] - 7 : 0);
